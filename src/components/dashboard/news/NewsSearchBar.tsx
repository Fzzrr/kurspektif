...
export default function NewsSearchBar({ value, onChange }: Props) {
  return (
    <label className="mx-auto flex w-full max-w-xl items-center gap-2 rounded-full bg-surface px-4 py-2.5 transition-[box-shadow] focus-within:ring-2 focus-within:ring-accent/30">
