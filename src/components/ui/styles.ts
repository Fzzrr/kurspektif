...
export const socialButtonClass =
  'inline-flex w-full items-center justify-center gap-2 rounded-lg border border-line bg-surface py-3 font-mono text-sm font-medium text-ink shadow-sm transition-colors hover:bg-accent-soft';
