...
export const bareInputClass =
  'block w-full rounded-lg bg-surface px-4 py-2.5 font-mono text-sm text-ink placeholder:text-muted/60 shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-accent/30';
...
export const socialButtonClass =
  'inline-flex w-full items-center justify-center gap-2 rounded-lg bg-surface py-3 font-mono text-sm font-medium text-ink shadow-sm transition-colors hover:bg-accent-soft';
